    ...
    xhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        ...
        for (let object of objects) {
          ...
          trHTML += '<td><button type="button" class="btn btn-success" onclick="showRolEditBox('+object['id']+')">🖉 Edit</button>';
          trHTML += '<button type="button" class="btn btn-danger" onclick="rolDelete('+object['id']+')">🗑Del</button></td>';
          trHTML += "</tr>";
        }
